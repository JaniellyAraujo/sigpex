...
?>
<h3 class="box-title"><i class="fa fa-list-ul"></i> Lista de Área de Conhecimento</h3>
                ...
                'nome',
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            return Html::a('<i class="fa fa-eye fa fa-white"></i>', $url, ['title' => 'Visualisar Área de Conhecimento',
                                        'class' => 'btn btn-info',
                            ]);
                        },
                        'update' => function ($url, $model) {
                            return Html::a('<i class="fa fa-pencil fa fa-white"></i>', $url, ['title' => 'Editar Área de Conhecimento',
                                        'class' => 'btn btn-primary',
                            ]);
                        },
                        'delete' => function ($url, $model) {
                            return Html::a('<i class="fa fa-trash fa fa-white"></i>', $url, ['title' => 'Excluir Área de Conhecimento',
