...
<div class="declaracao-index">
    ...
    <br><br>
            ...
            <div class="row">
                <div class="col-lg-12"> 
                    <b><h5 class="text-justify" style="font-size:16px;line-height:25px;">
                            Declaramos para os fins que se fizerem necessários que <strong><!--?php foreach($model->participante as $participante){echo $participante->nome;}?--></strong>
                        participou do projeto <strong> <?= Html::encode(Yii::$app->projeto->titulo) ?> </strong>realizado no Instituto Federal de Educação 
                        Ciência e Tecnologia do Norte de Minas Gerais - Campus Januária, <strong>.$projeto->municipio.</strong> no período de 
                        <strong>.$projeto->dataInicio.</strong> à <strong>.$projeto->datafim.</strong>, 
                        perfazendo uma carga horária total de <strong>.$projeto->cargHorariaTotal.</strong> horas.
        ...
        <br>
                   ...
                   <b><h5 class="text-center"> Januária, $dataEmissao</h5></b>
    </div>
    </div>
