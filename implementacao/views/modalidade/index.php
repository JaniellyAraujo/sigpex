...
<div class="panel panel-info">
    <div class="panel-heading">
        <h5 class="panel-title"><i class="fa fa-list-ul"></i> Lista de Modalidade de Projeto</h5>
    </div>
    <div class="box-body">
                ...
                'nome',
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            return Html::a('<i class="fa fa-eye fa fa-white"></i>', $url, ['title' => 'Visualizar Modalidade de Projeto',
                                        'class' => 'btn btn-info',
                            ]);
                        },
                        'update' => function ($url, $model) {
                            return Html::a('<i class="fa fa-pencil fa fa-white"></i>', $url, ['title' => 'Editar Modalidade de Projeto',
                                        'class' => 'btn btn-primary',
                            ]);
                        },
                        'delete' => function ($url, $model) {
                            return Html::a('<i class="fa fa-trash fa fa-white"></i>', $url, ['title' => 'Excluir Modalidade de Projeto',
