...
<div class="box-info box view-item col-xs-12 col-lg-12">
    ...
    <div class="box-body">
     <div class="pull-right">
                <button onClick="history.go(-1)" class="btn btn-default" ><b class="fa fa-arrow-left"></b> Voltar</button> <!--Exemmlo botão voltar -->
               <?= Html::a('<b class="fa fa-user-plus"></b> Equipe', ['/equipe/create/'], ['class' => 'btn btn-default']) ?>
        ...
        <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
            ...
            <div class="box-body">
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
                    <div class="col-md-7"><b>NOME: </b><?= Html::encode($model->titulo) ?></div>
                    <div class="col-md-2"><b>TIPO: </b><?= Html::encode($model->tipoProjeto) ?></div>
                    <div class="col-md-3"><b>MODALIDADE: </b><?= Html::encode($model->modalidade) ?></div><br><br>
                </div>
        ...
        <div class="pull-right">
            <button onClick="history.go(-1)" class="btn btn-default" ><b class="fa fa-arrow-left"></b> Voltar</button>
        </div><br><br>
    </div>
</div>
