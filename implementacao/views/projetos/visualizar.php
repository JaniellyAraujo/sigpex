    ...
    <div class="box-body">
        ...
        <div class="pull-right">
            ...
            <div class="form-group" align='right'>
                    <?php if (($model->isAtivo == 3)&&(Yii::$app->user->identity->nome == $model->coordenador)) { ?>
            ...
            <div class="box box-solid box-warning col-xs-12 col-lg-12 no-padding"> <!--Exemmlo botão voltar -->
                ...
                <div class="box-body">
                    <table class="table table-striped">
                        <tr><td>
                                <div  class="sigpex-link-box-text" class="col-xs-12 col-sm-12 col-lg-12 no-padding">
                    ...
                    <table class="table table-striped">
                        <tr><td>
                                <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
                                    <div class="sigpex-link-box-text"  class="col-md-7"><b>NOME: </b><?= Html::encode($model->titulo) ?></div>
                                    <div class="sigpex-link-box-text"  class="col-md-2"><b>TIPO: </b><?= Html::encode($model->tipoProjeto) ?></div>
                                </div>
                            </td></tr>
                    </table>
                </div>
