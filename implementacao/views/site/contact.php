...
<div class="site-contact">
    ...
    <div class="col-md-12 well bs-component">
        ...
        <div class="row">
            <div class="col-md-6"><?= $form->field($model, 'name')->textInput(['placeholder' => Yii::t('app', 'Informe seu nome'), 'autofocus' => true]) ?></div>
            <div class="col-md-6"><?= $form->field($model, 'email')->input('email', ['placeholder' => Yii::t('app', 'Informe seu e-mail')]) ?></div>
        </div>
        <div class="row">
            <div class="col-md-6"><?= $form->field($model, 'subject')->textInput(['placeholder' => Yii::t('app', 'Informe o assunto')]) ?></div>
