...
<html lang="<?= Yii::$app->language ?>">
    ...
    <p align="center">Esta é a área do Coordenador de Extensão. Clique nos links para acessar aos módulos.</p>
    <div class="site-coordenador">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                <div class="box-footer text-center">
                    <a href="../projetos/relatoriofinal" class="uppercase">Ver Todos</a>
                </div><!-- /.box-footer -->
            </div><!--/.box -->
        </div><!-- /.col -->
        ...
        <div class="col-md-6">
            ...
            <div class="box box-info">
                <div class="box-header with-border ">
                    <h3 class="box-title"><i class="fa fa-graduation-cap"></i> Gerenciar Certificados</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body no-padding">
        ...
        <div class="col-md-6">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-check-square-o"></i> Gerenciar Declarações</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body no-padding">
