...
<?php if (($model->isNewRecord) != false) { ?> 
    <h3 class="box-title"><i class="fa fa-plus"></i> Adicionar Status</h3>
<?php } ?>
<?php if (($model->isNewRecord) == false) { ?> 
    <h3 class="box-title"><i class="fa fa-pencil-square"></i> Atualizar Status</h3>
<?php } ?>
<div class="panel panel-info">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <div class="pull-left">
                <?php if (($model->isNewRecord) == false) { ?> 
                <?= Html::a('Cancelar', ['status/index'], ['class' => 'btn btn-default','style' => 'margin-right:10px']) ?>
                 <?php } ?>
            </div>
            <div class="pull-left">
